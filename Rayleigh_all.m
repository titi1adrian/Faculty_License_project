...
h = 1/sqrt(2)*(randn(1,N/2) + 1i*randn(1,N/2)); % canalul afectat de fading Rayleigh
...
xlabel('Timp');
ylabel('Amplitudine');
title('Caracteristica canalului afectat de fading Rayleigh');
%}

figure(2)
semilogy(rap_dB,BER,'ro-','LineWidth',2);
grid on
legend('Canal Rayleigh Simulat');
xlabel('Eb/No [dB]');
ylabel('Rata Erorii de Bit');
title('BER Pentru un semnal modulat QPSK print-un canal afectat de fading Rayleigh');
